...
public class DisplayUtil {
    ...
    public static int px2dip(float pxValue) {
        final float scale = CommonApplication.getAppApplicationContext().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(float pxValue) {
        final float fontScale = CommonApplication.getAppApplicationContext().getResources().getDisplayMetrics().scaledDensity;
