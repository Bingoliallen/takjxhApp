 ...
 * @Description:
 **/
public class ChildrenDialogAdapter extends BaseAdapter {
    ...
    public ChildrenDialogAdapter(Context context, List<Children> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Children dictUnit = mData.get(position);
