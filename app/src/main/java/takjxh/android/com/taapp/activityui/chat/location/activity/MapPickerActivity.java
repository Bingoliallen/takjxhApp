package takjxh.android.com.taapp.activityui.chat.location.activity;
...
import takjxh.android.com.taapp.activityui.chat.location.adapter.MapPickerAdapter;
...
public class MapPickerActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationService = QbApplication.mBaseApplication.locationService;
        ...
        ConversationType convType = (ConversationType) getIntent().getSerializableExtra(CONV_TYPE);
        String targetId = getIntent().getStringExtra(TARGET_ID);
        String targetAppKey = getIntent().getStringExtra(TARGET_APP_KEY);
        if (convType != null) {
            switch (convType) {
                case single:
    ...
    private void initIntent() {
        ...
        if (mSendLocation) {
            ...
            BitmapDescriptor descriptor = BitmapDescriptorFactory.fromResource(R.drawable.arrow2);
                ...
                mBaiduMap.snapshotScope(rect, new BaiduMap.SnapshotReadyCallback() {
                    ...
                    public void onSnapshotReady(Bitmap bitmap) {
                        if (null != bitmap && null != conv) {
                            ...
                            setResult(RESULT_CODE_SEND_LOCATION, intent);
                            finish();
                        } else {
                            Toast.makeText(MapPickerActivity.this, MapPickerActivity.this.getString(R.string.send_location_error),
