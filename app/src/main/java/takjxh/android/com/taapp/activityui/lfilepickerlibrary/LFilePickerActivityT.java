...
public class LFilePickerActivityT extends AppCompatActivity {
                ...
                if (mParamEntity.isMutilyMode()) {
                    if (mListFiles.get(position).isDirectory()) {
                        ...
                        if (mParamEntity.getMaxNum() > 0 && mListNumbers.size() > mParamEntity.getMaxNum()) {
                            Toast.makeText(LFilePickerActivityT.this, R.string.OutSize, Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                } else {
                    ...
                    if (mParamEntity.isChooseMode()) {
                        ...
                        Toast.makeText(LFilePickerActivityT.this, R.string.ChooseTip, Toast.LENGTH_SHORT).show();
                    }
                }
            ...
            public void onClick(View v) {
                if (mParamEntity.isChooseMode() && mListNumbers.size() < 1) {
                    ...
                    if (TextUtils.isEmpty(info)) {
                        Toast.makeText(LFilePickerActivityT.this, R.string.NotFoundBooks, Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(LFilePickerActivityT.this, info, Toast.LENGTH_SHORT).show();
                    }
                } else {
                    //返回
                    chooseDone();
