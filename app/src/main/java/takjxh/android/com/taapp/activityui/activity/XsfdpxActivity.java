...
public class XsfdpxActivity extends BaseActivity<XsfdpxPresenter> implements IXsfdpxPresenter.IView, View.OnClickListener {
    ...
    public static void startAction(Activity activity) {
        Intent intent = new Intent(activity, XsfdpxActivity.class);
    ...
    protected void initEvent() {
        ...
        toMore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TabManageActivity.startAction(XsfdpxActivity.this,mList);
            }
        });
    }
    ...
    public void traintypelistSuccess(List<TrainTypeBean.TrainTypesBean> data) {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            Fragment fragment = XsfdpxFragment.newInstance(data.get(i).getCode());
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                EventBus.getDefault().post(new XsfdpxRef(mList.get(tab.getPosition()).getCode()));
