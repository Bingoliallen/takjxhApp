    ...
    public static final class Builder
        ...
        public void onShow(BaseDialog dialog) {
            postDelayed(new Runnable() {
                @Override
                public void run() {
                    ((InputMethodManager)getActivity().getSystemService(Context.INPUT_METHOD_SERVICE)).showSoftInput(mInputView, 0);
                }
            }, 500);
        }
        ...
        public void onDismiss(BaseDialog dialog) {
            ((InputMethodManager)getActivity().getSystemService(Context.INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(mInputView.getWindowToken(), 0);
        }
