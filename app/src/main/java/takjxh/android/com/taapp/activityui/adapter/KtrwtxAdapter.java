...
public class KtrwtxAdapter extends BaseRecyclerAdapter<IssueDetailBean.Question1Bean> {
    ...
    @Override
    public void onBind(ViewHolder holder, final IssueDetailBean.Question1Bean item, final int position) {
    ...
    public void setmClickListener(OnKtrwtxClickListener mClickListener) {
        this.mClickListener = mClickListener;
    }

    private void radioButtonL(final IssueDetailBean.Question1Bean item, final int position, final int pos) {
        boolean isto = false;
        boolean isSel = false;
        for (int a = 0; a < item.getItems().size(); a++) {
    ...
    private void checkBoxL(final IssueDetailBean.Question1Bean item, final int position, final int pos, final boolean isChecked) {
