...
public class CountDownViewT extends View {
    ...
    private String mText = "跳过";//要绘制的文字
    private int mWidth;
    private int mHeight;
    private AnimatorSet set;

    public CountDownViewT(Context context) {
        this(context, null);
    }

    public CountDownViewT(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CountDownViewT(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;

        TypedArray array = context.obtainStyledAttributes(attrs, com.ns.yc.yccountdownviewlib.R.styleable.CountDownView);
        mRetreatType = array.getInt(com.ns.yc.yccountdownviewlib.R.styleable.CountDownView_cd_retreat_type, 1);
        location = array.getInt(com.ns.yc.yccountdownviewlib.R.styleable.CountDownView_cd_location, 1);
        mCircleRadius = (int) array.getDimension(com.ns.yc.yccountdownviewlib.R.styleable.CountDownView_cd_circle_radius, dip2px(context, 25));//默认25dp
        mPaintArcWidth = array.getDimension(com.ns.yc.yccountdownviewlib.R.styleable.CountDownView_cd_arc_width, dip2px(context, 3));//默认3dp
        mPaintArcColor = array.getColor(com.ns.yc.yccountdownviewlib.R.styleable.CountDownView_cd_arc_color, mPaintArcColor);
        mTextSize = (int) array.getDimension(com.ns.yc.yccountdownviewlib.R.styleable.CountDownView_cd_text_size, dip2px(context, 14));//默认14sp
        mTextColor = array.getColor(com.ns.yc.yccountdownviewlib.R.styleable.CountDownView_cd_text_color, mTextColor);
        mPaintBackGroundColor = array.getColor(com.ns.yc.yccountdownviewlib.R.styleable.CountDownView_cd_bg_color, mPaintBackGroundColor);
        mLoadingTime = array.getInteger(com.ns.yc.yccountdownviewlib.R.styleable.CountDownView_cd_animator_time, 3);//默认3秒
        mLoadingTimeUnit = array.getString(com.ns.yc.yccountdownviewlib.R.styleable.CountDownView_cd_animator_time_unit);//时间单位
