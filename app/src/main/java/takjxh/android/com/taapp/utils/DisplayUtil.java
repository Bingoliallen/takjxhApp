...
public class DisplayUtil {
    ...
    public static int px2dip(float pxValue) {
        final float scale = QbApplication.getAppContext().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(float pxValue) {
        final float fontScale = QbApplication.getAppContext().getResources().getDisplayMetrics().scaledDensity;
